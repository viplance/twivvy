...
import { createMatch, resolveTick, isValidCommand, DECIDE_MS, TICKS } from "./rules.js?v=20260910-joinmodal1";
import { sha256Hex, encodeCommand, decodeCommand } from "./net.js?v=20260910-joinmodal1";
